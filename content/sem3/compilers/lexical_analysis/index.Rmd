...
* An **alphabet** is any fintie set of symbols.
...
After Kleene introduced regular expressions with basic operators such as union, concatenation, and Kleene closure. extensions have been added. These extensions have been incorporated into software such as Unix utilties (`lex`) that are useful for lexical analyzers.
