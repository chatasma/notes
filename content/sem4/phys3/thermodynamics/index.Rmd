...
* Adibiatic: Q = 0 (insulation prevents heat transfer)
* Constant Volume: W = 0
* Closed Cycle: Q = W
...
For this, we notice that -160J `ca` quantity refers to the net change of energy over that path. Though, for `ab` and `bc` its 200J and 40J quantity (respectively) corresponds to heat absorption. So over the path we have these changes:

$$
\Delta E_{int} = (200) + (40 - 0) + (0 - 160)
$$
...
Notice that 80J is our answer for both paths `ab` and `abc`.
