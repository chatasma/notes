...
First, pain threshold is `120 dB`. For an isotropic source, the intensity is given by formula \ref{eq:isotropic_intensity}.

So:

$$
\beta = ( 10\ dB ) log \frac{r^{2}_{O}}{r^{2}}
$$

$$
r = \sqrt{\frac{(1000\ m)^{2}}{10^{12}}}
$$
